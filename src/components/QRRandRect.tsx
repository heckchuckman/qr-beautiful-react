...
function listPoints({ qrcode, baseColor, accentColor }: QRRandRectProps) {
	if (!qrcode) return []
	...
	baseColor = baseColor! || "#000000"
	accentColor = accentColor! || "#4183c4"

	baseColor = hexRgb(baseColor, { format: "css" })
	accentColor = hexRgb(accentColor, { format: "css" })
